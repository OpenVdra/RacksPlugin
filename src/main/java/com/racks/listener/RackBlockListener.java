 ...
 * creative can. That break is treated as breaking the rack, which is what the person swinging
 * clearly meant. The rack comes apart the same way it would from a left-click, so whatever it was
 * holding still drops and no orphaned entities or database rows are left behind.
 */
